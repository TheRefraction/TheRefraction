...
🎓 **Computer Science Student** at UTBM (Expected Graduation: **2028**)  
📍 **Belfort, France**

[![Portfolio](https://img.shields.io/badge/Website-Portfolio-000000?style=for-the-badge&logo=github&logoColor=white)](https://therefraction.github.io)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/corentin-hautefaye-095125291/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:the.r3fraction@gmail.com)
...
![Assembly](https://img.shields.io/badge/ASM-00599C?style=for-the-badge&logo=assemblyscript&logoColor=white)
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p align="center">
        <code>GameMaker</code> • <code>Music Composition</code> • <code>Pixel Art</code>
      </p>
      <ul>
        <li>Chapter 2 currently in active development.</li>
        <li>Features custom soundtrack and hand-crafted mechanics.</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3 align="center"><a href="https://github.com/TheRefraction/Neptune">Neptune/OS</a></h3>
      <p align="center">
        <em>An experimental 32-bit operating system kernel built from scratch.</em>
      </p>
      <p align="center">
        <code>C</code> • <code>x86 Assembly</code> • <code>Low-Level Hardware</code>
      </p>
      <ul>
        <li>Explores bare-metal memory management, interrupts, and drivers.</li>
        <li>Designed for learning low-level system mechanics.</li>
      </ul>
    </td>
  </tr>
</table>
